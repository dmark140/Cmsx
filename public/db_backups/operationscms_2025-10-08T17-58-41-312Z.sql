...
VALUES
  (5, 1, 6, '2025-07-24 14:15:53', 1, 4, 1);
INSERT INTO
  `approvals_decisions` (
    `DocNum`,
    `ApprovalApproverID`,
...
VALUES
  (6, 1, 6, '2025-07-24 14:18:12', 0, 5, 1);
INSERT INTO
  `approvals_decisions` (
    `DocNum`,
    `ApprovalApproverID`,
...
VALUES
  (7, 1, 6, '2025-07-24 14:49:42', 0, 6, 1);
INSERT INTO
  `approvals_decisions` (
    `DocNum`,
    `ApprovalApproverID`,
...
VALUES
  (8, 1, 8, '2025-07-24 20:20:34', 0, 7, 1);
INSERT INTO
  `approvals_decisions` (
    `DocNum`,
    `ApprovalApproverID`,
...
VALUES
  (9, 3, 2, '2025-08-18 20:01:53', 1, 13, 1);
INSERT INTO
  `approvals_decisions` (
    `DocNum`,
    `ApprovalApproverID`,
...
VALUES
  (10, 4, 2, '2025-08-18 20:01:53', 1, 13, 1);
INSERT INTO
  `approvals_decisions` (
    `DocNum`,
    `ApprovalApproverID`,
...
VALUES
  (11, 1, 2, '2025-08-18 20:01:53', 1, 13, 1);
INSERT INTO
  `approvals_decisions` (
    `DocNum`,
    `ApprovalApproverID`,
...
VALUES
  (12, 3, 2, '2025-08-18 20:22:41', 1, 14, 1);
INSERT INTO
  `approvals_decisions` (
    `DocNum`,
    `ApprovalApproverID`,
...
VALUES
  (13, 4, 2, '2025-08-18 20:22:41', 1, 14, 1);
INSERT INTO
  `approvals_decisions` (
    `DocNum`,
    `ApprovalApproverID`,
...
VALUES
  (14, 1, 2, '2025-08-18 20:22:41', 1, 1, 1);
INSERT INTO
  `approvals_decisions` (
    `DocNum`,
    `ApprovalApproverID`,
...
VALUES
  (15, 3, 2, '2025-08-18 22:06:35', 1, 15, 1);
INSERT INTO
  `approvals_decisions` (
    `DocNum`,
    `ApprovalApproverID`,
...
VALUES
  (16, 4, 2, '2025-08-18 22:06:35', 1, 15, 1);
INSERT INTO
  `approvals_decisions` (
    `DocNum`,
    `ApprovalApproverID`,
...
VALUES
  (17, 1, 2, '2025-08-18 22:06:35', 1, 15, 1);
INSERT INTO
  `approvals_decisions` (
    `DocNum`,
    `ApprovalApproverID`,
...
VALUES
  (18, 1, 15, '2025-08-18 22:18:32', 1, 8, 1);
INSERT INTO
  `approvals_decisions` (
    `DocNum`,
    `ApprovalApproverID`,
...
VALUES
  (19, 3, 2, '2025-10-08 20:04:39', 1, 16, 1);
INSERT INTO
  `approvals_decisions` (
    `DocNum`,
    `ApprovalApproverID`,
...
VALUES
  (20, 4, 2, '2025-10-08 20:04:39', 1, 16, 1);
INSERT INTO
  `approvals_decisions` (
    `DocNum`,
    `ApprovalApproverID`,
...
VALUES
  (21, 1, 2, '2025-10-08 20:04:39', 1, 16, 1);
...
VALUES
  (28, 1, '2025-07-25 00:03:23', 'asd', 'Form1', 1);
INSERT INTO
  `projects` (
    `DocEntry`,
    `AddedBy`,
...
VALUES
  (1, 1, 28, '2025-07-17 17:07:58', 1, 0);
INSERT INTO
  `projects_data_a_header` (
    `DocEntry`,
    `CreatedBy`,
...
VALUES
  (2, 1, 28, '2025-07-19 01:01:12', 1, 0);
INSERT INTO
  `projects_data_a_header` (
    `DocEntry`,
    `CreatedBy`,
...
VALUES
  (3, 1, 28, '2025-07-24 13:58:53', 1, 0);
INSERT INTO
  `projects_data_a_header` (
    `DocEntry`,
    `CreatedBy`,
...
VALUES
  (4, 1, 28, '2025-07-24 14:15:52', 1, 0);
INSERT INTO
  `projects_data_a_header` (
    `DocEntry`,
    `CreatedBy`,
...
VALUES
  (5, 1, 28, '2025-07-24 14:18:11', 1, 0);
INSERT INTO
  `projects_data_a_header` (
    `DocEntry`,
    `CreatedBy`,
...
VALUES
  (6, 1, 28, '2025-07-24 14:49:41', 1, 0);
INSERT INTO
  `projects_data_a_header` (
    `DocEntry`,
    `CreatedBy`,
...
VALUES
  (7, 1, 28, '2025-07-24 20:20:33', 1, 0);
INSERT INTO
  `projects_data_a_header` (
    `DocEntry`,
    `CreatedBy`,
...
VALUES
  (8, 1, 28, '2025-08-18 22:18:31', 1, 0);
...
VALUES
  (
    ...
    8,
    52,
    '/uploads/1755526691323-kurzgesagt-4k-wallpapers-3840x2160-v0-cvp0lsq283ib1.webp',
    1
  );
